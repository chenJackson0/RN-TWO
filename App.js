...
const TabNavigator = createBottomTabNavigator({
  HomePage: {
    screen: HomePage, navigationOptions: ({ navigation }) => ({
      tabBarLabel: '首页',
      tabBarIcon: ({ focused }) => {
        if (!focused) {
          return (
  ...
  Rearch: {
    screen: Rearch, navigationOptions: ({ navigation }) => ({
      tabBarLabel: '搜索',
      tabBarIcon: ({ focused }) => {
        if (!focused) {
          return (
  ...
  Collection: {
    screen: Collection, navigationOptions: ({ navigation }) => ({
      tabBarLabel: '说说',
      tabBarIcon: ({ focused }) => {
        if (!focused) {
          return (
  ...
  PersonalCenter: {
    screen: PersonalCenter, navigationOptions: ({ navigation }) => ({
      tabBarLabel: '个人中心',
      tabBarIcon: ({ focused }) => {
        if (!focused) {
          return (
...
const RootStack = createStackNavigator(
  {
    ...
    Registered: {
      screen: Registered, navigationOptions: ({ navigation }) => ({
        headerTitle: "注册",
        header: null,
      })
    },
    ...
    ComList: {
      screen: ComList, navigationOptions: ({ navigation }) => ({
        // headerTitle:"首页",
        header: null
      })
    },
    EditPage: {
      screen: EditPage, navigationOptions: ({ navigation }) => ({
        // headerTitle:"首页",
        header: null
      })
    },
    Published: {
      screen: Published, navigationOptions: ({ navigation }) => ({
        // headerTitle:"首页",
        header: null
      })
    },
    VerificationCode: {
      screen: VerificationCode, navigationOptions: ({ navigation }) => ({
        headerTitle: "填写验证码",
      })
    },
    SetPassWord: {
      screen: SetPassWord, navigationOptions: ({ navigation }) => ({
        headerTitle: "确定密码",
      })
    },
    Detail: {
    ...
    DuthonPerCenter: {
      screen: DuthonPerCenter, navigationOptions: ({ navigation }) => ({
        header: null
      })
    },
    Projuct: {
      screen: Projuct, navigationOptions: ({ navigation }) => ({
        header: null
      })
    },
    CartShopping: {
      screen: CartShopping, navigationOptions: ({ navigation }) => ({
        header: null
      })
    },
  },

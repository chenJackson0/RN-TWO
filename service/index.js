...
<<<<<<< HEAD
  return await get_fetch('http://127.0.0.1:27017/registered/registered',data,'application/json')
=======
...
getUser = async (data) => {
<<<<<<< HEAD
  return await get_fetch('http://127.0.0.1:27017/registered/getUser',data,'application/json')
}
//登陆
login = async (data) => {
  return await get_fetch('http://127.0.0.1:27017/registered/login',data,'application/json')
}
//发布作品
published = async (data) => {
  return await get_fetch('http://127.0.0.1:27017/published/published',data,'application/json')
}
//查找作品
